...
file(READ "${LITEIME_SOURCE_DIR}/setup-dev.ps1" setup_text)
...
if(NOT EXISTS "${LITEIME_SOURCE_DIR}/platform/windows/installer/main.cpp")
    message(FATAL_ERROR "Native LiteIME installer source is missing")
endif()
file(READ "${LITEIME_SOURCE_DIR}/platform/windows/installer/main.cpp" installer_text)
file(READ "${LITEIME_SOURCE_DIR}/platform/windows/installer/install_layout.cpp" installer_layout_text)
...
if(NOT cmake_text MATCHES "add_executable\\(LiteIME-Install")
    message(FATAL_ERROR "CMake must build LiteIME-Install.exe")
endif()
...
if(installer_text MATCHES "Dev[/\\\\]bin[/\\\\]LiteImeTSF\\.dll")
...
if(NOT setup_text MATCHES "LiteIME-Install\\.exe" OR NOT setup_text MATCHES "--silent")
